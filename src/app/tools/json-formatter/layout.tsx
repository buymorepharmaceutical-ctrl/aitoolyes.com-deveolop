...
export const metadata: Metadata = {
  title: "Free Online Json Formatter Tool | AI ToolYes",
  description: "Use the free online Json Formatter to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/json-formatter" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Json%20Formatter%20Tool']
  }
};
