...
export const metadata: Metadata = {
  title: "Free Online Uuid Tool | AI ToolYes",
  description: "Use the free online Uuid to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/uuid" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Uuid%20Tool']
  }
};
