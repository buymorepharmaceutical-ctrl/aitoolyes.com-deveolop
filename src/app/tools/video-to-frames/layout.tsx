...
export const metadata: Metadata = {
  title: "Free Online Video To Frames Tool | AI ToolYes",
  description: "Use the free online Video To Frames to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/video-to-frames" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Video%20To%20Frames%20Tool']
  }
};
