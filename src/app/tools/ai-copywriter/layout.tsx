...
export const metadata: Metadata = {
  title: "Free Online Ai Copywriter Tool | AI ToolYes",
  description: "Use the free online Ai Copywriter to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/ai-copywriter" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Ai%20Copywriter%20Tool']
  }
};
