...
export const metadata: Metadata = {
  title: "Free Online Ai Summarizer Tool | AI ToolYes",
  description: "Use the free online Ai Summarizer to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/ai-summarizer" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Ai%20Summarizer%20Tool']
  }
};
