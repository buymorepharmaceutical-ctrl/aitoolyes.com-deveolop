...
export const metadata: Metadata = {
  title: "Free Online Docker Compose Tool | AI ToolYes",
  description: "Use the free online Docker Compose to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/docker-compose" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Docker%20Compose%20Tool']
  }
};
