...
export const metadata: Metadata = {
  title: "Free Online Password Generator Tool | AI ToolYes",
  description: "Use the free online Password Generator to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/password-generator" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Password%20Generator%20Tool']
  }
};
