...
export const metadata: Metadata = {
  title: "Free Online Ai Insights Tool | AI ToolYes",
  description: "Use the free online Ai Insights to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/ai-insights" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Ai%20Insights%20Tool']
  }
};
