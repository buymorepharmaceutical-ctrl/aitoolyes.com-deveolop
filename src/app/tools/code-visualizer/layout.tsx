...
export const metadata: Metadata = {
  title: "Free Online Code Visualizer Tool | AI ToolYes",
  description: "Use the free online Code Visualizer to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/code-visualizer" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Code%20Visualizer%20Tool']
  }
};
