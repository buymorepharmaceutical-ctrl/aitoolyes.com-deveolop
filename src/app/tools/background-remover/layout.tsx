...
export const metadata: Metadata = {
  title: "Free Online Background Remover Tool | AI ToolYes",
  description: "Use the free online Background Remover to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/background-remover" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Background%20Remover%20Tool']
  }
};
