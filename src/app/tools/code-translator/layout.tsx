...
export const metadata: Metadata = {
  title: "Free Online Code Translator Tool | AI ToolYes",
  description: "Use the free online Code Translator to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/code-translator" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Code%20Translator%20Tool']
  }
};
