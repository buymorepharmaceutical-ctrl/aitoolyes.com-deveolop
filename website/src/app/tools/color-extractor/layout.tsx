...
export const metadata: Metadata = {
  title: "Free Online Color Extractor Tool | AI ToolYes",
  description: "Use the free online Color Extractor to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/color-extractor" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Color%20Extractor%20Tool']
  }
};
