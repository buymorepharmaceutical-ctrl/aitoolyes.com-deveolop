...
export const metadata: Metadata = {
  title: "Free Online Api Client Tool | AI ToolYes",
  description: "Use the free online Api Client to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/api-client" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Api%20Client%20Tool']
  }
};
