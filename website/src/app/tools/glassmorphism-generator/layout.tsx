...
export const metadata: Metadata = {
  title: "Free Online Glassmorphism Generator Tool | AI ToolYes",
  description: "Use the free online Glassmorphism Generator to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/glassmorphism-generator" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Glassmorphism%20Generator%20Tool']
  }
};
