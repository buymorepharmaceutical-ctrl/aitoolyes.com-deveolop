...
export const metadata: Metadata = {
  title: "Free Online Sql Formatter Tool | AI ToolYes",
  description: "Use the free online Sql Formatter to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/sql-formatter" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Sql%20Formatter%20Tool']
  }
};
