...
export const metadata: Metadata = {
  title: "Free Online Base64 Tool | AI ToolYes",
  description: "Use the free online Base64 to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/base64" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Base64%20Tool']
  }
};
