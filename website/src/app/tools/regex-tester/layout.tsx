...
export const metadata: Metadata = {
  title: "Free Online Regex Tester Tool | AI ToolYes",
  description: "Use the free online Regex Tester to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/regex-tester" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Regex%20Tester%20Tool']
  }
};
