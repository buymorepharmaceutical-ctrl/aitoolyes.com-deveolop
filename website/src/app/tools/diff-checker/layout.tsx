...
export const metadata: Metadata = {
  title: "Free Online Diff Checker Tool | AI ToolYes",
  description: "Use the free online Diff Checker to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/diff-checker" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Diff%20Checker%20Tool']
  }
};
