...
export const metadata: Metadata = {
  title: "Free Online Qrcode Tool | AI ToolYes",
  description: "Use the free online Qrcode to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/qrcode" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Qrcode%20Tool']
  }
};
