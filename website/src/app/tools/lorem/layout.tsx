...
export const metadata: Metadata = {
  title: "Free Online Lorem Tool | AI ToolYes",
  description: "Use the free online Lorem to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/lorem" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Lorem%20Tool']
  }
};
