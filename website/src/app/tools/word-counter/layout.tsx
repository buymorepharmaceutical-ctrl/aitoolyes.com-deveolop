...
export const metadata: Metadata = {
  title: "Free Online Word Counter Tool | AI ToolYes",
  description: "Use the free online Word Counter to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/word-counter" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Word%20Counter%20Tool']
  }
};
