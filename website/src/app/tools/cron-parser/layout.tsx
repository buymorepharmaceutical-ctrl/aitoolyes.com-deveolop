...
export const metadata: Metadata = {
  title: "Free Online Cron Parser Tool | AI ToolYes",
  description: "Use the free online Cron Parser to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/cron-parser" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Cron%20Parser%20Tool']
  }
};
