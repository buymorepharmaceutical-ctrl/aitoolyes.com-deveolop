...
export const metadata: Metadata = {
  title: "Free Online Markdown Tool | AI ToolYes",
  description: "Use the free online Markdown to boost your developer productivity. Instantly process data securely in your browser.",
  alternates: { canonical: "https://aitoolyes.com/tools/markdown" },
  openGraph: {
    images: ['https://aitoolyes.com/api/og?title=Free%20Online%20Markdown%20Tool']
  }
};
